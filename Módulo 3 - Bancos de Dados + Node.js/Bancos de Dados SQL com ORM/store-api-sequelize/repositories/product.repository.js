...
async function createProduct(product) {
  ...
  try {
    ...
    const values = [product.name, product.description, product.value, product.stock, product.supplier_id]; // prettier-ignore
...
async function updateProduct(product) {
  ...
  try {
    ...
    const values = [product.name, product.description, product.value, product.stock, product.supplier_id, product.product_id]; // prettier-ignore
    const res = await conn.query(sql, values);
